...
export const initialState = {
  ...
  isTrainingErrorSnackbarOpen: false,
}
...
export const ACTION_TYPES = {
  ...
  DISPLAY_TRAINING_ERROR_SNACKBAR: 'DISPLAY_TRAINING_ERROR_SNACKBAR',
  HIDE_TRAINING_ERROR_SNACKBAR: 'HIDE_TRAINING_ERROR_SNACKBAR',
}
...
export const reducer = (state = initialState, action) => {
  const actionReducers = {
    ...
    [ACTION_TYPES.DISPLAY_TRAINING_ERROR_SNACKBAR]: () => ({
      ...state,
      isTrainingErrorSnackbarOpen: true,
    }),
    [ACTION_TYPES.HIDE_TRAINING_ERROR_SNACKBAR]: () => ({
      ...state,
      isTrainingErrorSnackbarOpen: false,
    }),
  }
